...
public class Cavurn extends JMonsterEntity {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.CAVURN_HEALTH)
    ...
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.cavurn.walk");
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.cavurn.idle");
