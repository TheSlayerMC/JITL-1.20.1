...
public class HellCow extends JAnimalEntity {
    ...
    public HellCow(EntityType<? extends JAnimalEntity> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, Ingredient.of(JItems.HELL_SHARDS.get()), false));
    ...
    public boolean isFood(@NotNull ItemStack itemStack) {
        return itemStack.is(JItems.HELL_SHARDS.get());
    }
