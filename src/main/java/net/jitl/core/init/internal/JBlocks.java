...
public class JBlocks {
    ...
    public static final RegistryObject<Block> NETHER_DUNGEON_BRICKS = register("nether_dungeon_bricks", "Nether Dungeon Bricks", JBlockProperties.DUNGEON_BLOCK);
    public static final RegistryObject<Block> LARGE_NETHER_BRICKS = register("large_nether_bricks", "Large Nether Bricks", JBlockProperties.DUNGEON_BLOCK);
    public static final RegistryObject<Block> NETHIC_LAMP = register("nethic_lamp", "Nethic Lamp", JBlockProperties.GLOW_BLOCK);
    public static final RegistryObject<StairBlock> NETHER_DUNGEON_BRICK_STAIRS = registerStairs("nether_dungeon_brick_stairs", "Nether Dungeon Brick Stairs", NETHER_DUNGEON_BRICKS, false, JBlockProperties.DUNGEON_BLOCK);
    public static final RegistryObject<JFenceBlock> NETHER_DUNGEON_BRICK_FENCE = registerFence("nether_dungeon_brick_fence", "Nether Dungeon Brick Fence", false, JBlockProperties.DUNGEON_BLOCK);
    ...
    public static final RegistryObject<Block> SWAMP_LAMP = registerModeledBlock("swamp_lamp", "Swamp Lamp", JBlockSwampLamp::new);
    ...
    public static final RegistryObject<Block> TERRANIAN_PLANKS = register("terranian_planks", "Terranian Planks", JBlockProperties.WOOD);
    public static final RegistryObject<DoorBlock> TERRANIAN_DOOR = registerDoor("terranian_door", "Terranian Door", true, JBlockProperties.DOOR);
    public static final RegistryObject<TrapDoorBlock> TERRANIAN_TRAP_DOOR = registerTrapDoor("terranian_trap_door", "Terranian Trap Door", true, JBlockProperties.DOOR);
    public static final RegistryObject<StairBlock> TERRANIAN_STAIRS = registerStairs("terranian_stairs", "Terranian Plank Stairs", CORBA_PLANKS, true, JBlockProperties.WOOD);
    public static final RegistryObject<SlabBlock> TERRANIAN_SLAB = registerSlab("terranian_slab", "Terranian Plank Slab", true, JBlockProperties.WOOD);
    public static final RegistryObject<ButtonBlock> TERRANIAN_BUTTON = registerButton("terranian_button", "Terranian Button", true, true, JBlockProperties.BUTTON);
    public static final RegistryObject<PressurePlateBlock> TERRANIAN_PRESSURE_PLATE = registerPressurePlate("terranian_pressure_plate", "Terranian Pressure Plate", true, JBlockProperties.WOOD);
    public static final RegistryObject<JFenceBlock> TERRANIAN_POST = registerFence("terranian_post", "Terranian Post", true, JBlockProperties.WOOD);
    public static final RegistryObject<FenceGateBlock> TERRANIAN_FENCE_GATE = registerFenceGate("terranian_fence_gate", "Terranian Fence Gate", true, JBlockProperties.WOOD);
    ...
    public static final RegistryObject<DoorBlock> CLOUDIA_DOOR = registerDoor("cloudia_door", "Cloudia Door", true, JBlockProperties.DOOR);
    public static final RegistryObject<TrapDoorBlock> CLOUDIA_TRAP_DOOR = registerTrapDoor("cloudia_trap_door", "Cloudia Trap Door", true, JBlockProperties.DOOR);
    public static final RegistryObject<StairBlock> CLOUDIA_STAIRS = registerStairs("cloudia_stairs", "Cloudia Plank Stairs", CORBA_PLANKS, true, JBlockProperties.WOOD);
    public static final RegistryObject<SlabBlock> CLOUDIA_SLAB = registerSlab("cloudia_slab", "Cloudia Plank Slab", true, JBlockProperties.WOOD);
    public static final RegistryObject<ButtonBlock> CLOUDIA_BUTTON = registerButton("cloudia_button", "Cloudia Button", true, true, JBlockProperties.BUTTON);
    public static final RegistryObject<PressurePlateBlock> CLOUDIA_PRESSURE_PLATE = registerPressurePlate("cloudia_pressure_plate", "Cloudia Pressure Plate", true, JBlockProperties.WOOD);
    public static final RegistryObject<FenceGateBlock> CLOUDIA_FENCE_GATE = registerFenceGate("cloudia_fence_gate", "Cloudia Fence Gate", true, JBlockProperties.WOOD);
    public static final RegistryObject<JFenceBlock> CLOUDIA_FENCE = registerFence("cloudia_fence", "Cloudia Fence", true, JBlockProperties.WOOD);
