...
//        this.dropSelf(JBlocks.DEEPSLATE_VERDITE_ORE);
        ...
        this.dropSelf(JBlocks.DEPTHS_CRYSTAL_BLOCK);
        this.dropSelf(JBlocks.BUDDING_DEPTHS_CRYSTAL);
        ...
        this.dropSelf(JBlocks.TERRANIAN_PLANKS);
        this.add(JBlocks.TERRANIAN_DOOR, this::createDoorTable);
        this.dropSelf(JBlocks.TERRANIAN_TRAP_DOOR);
        this.dropSelf(JBlocks.TERRANIAN_STAIRS);
        this.add(JBlocks.TERRANIAN_SLAB, this::createSlabItemTable);
        this.dropSelf(JBlocks.TERRANIAN_BUTTON);
        this.dropSelf(JBlocks.TERRANIAN_PRESSURE_PLATE);
        this.dropSelf(JBlocks.TERRANIAN_FENCE_GATE);
        ...
        this.add(JBlocks.CLOUDIA_DOOR, this::createDoorTable);
        this.dropSelf(JBlocks.CLOUDIA_TRAP_DOOR);
        this.dropSelf(JBlocks.CLOUDIA_STAIRS);
        this.add(JBlocks.CLOUDIA_SLAB, this::createSlabItemTable);
        this.dropSelf(JBlocks.CLOUDIA_BUTTON);
        this.dropSelf(JBlocks.CLOUDIA_PRESSURE_PLATE);
        this.dropSelf(JBlocks.CLOUDIA_FENCE_GATE);
        this.dropSelf(JBlocks.CLOUDIA_FENCE);
        ...
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_BARS);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_BRICKS);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_BRICK_STAIRS);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_CARVED_ROCK);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_FLOOR);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_ROCK);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_GLASS);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_GUARDIAN_LAMP);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_LIGHT_LAMP);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_MELLOW_LAMP);
        this.dropSelf(JBlocks.BREAKABLE_SENTERIAN_POST);
