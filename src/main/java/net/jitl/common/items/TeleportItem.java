...
public class TeleportItem extends JItem implements IEssenceItem {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand usedHand) {
        ...
        BlockHitResult var22 = level.clip(new ClipContext(var12, var21, ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, null));
        if (var22 == null) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        addItemDesc(JItems.TELEPORTATION_STAFF.get().asItem(), tooltip, "jitl.tooltip.teleport");
