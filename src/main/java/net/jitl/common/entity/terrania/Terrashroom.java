...
public class Terrashroom extends JMonsterEntity {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.TERRASHROOM_HEALTH)
                .add(Attributes.ATTACK_DAMAGE, MobStats.TERRASHROOM_DAMAGE)
    ...
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.terrashroom.idle");
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.terrashroom.walk");
