...
public class MediumHongo extends JNeutralMonster {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.MEDIUM_HONGO_HEALTH)
                .add(Attributes.ATTACK_DAMAGE, MobStats.MEDIUM_HONGO_DAMAGE)
