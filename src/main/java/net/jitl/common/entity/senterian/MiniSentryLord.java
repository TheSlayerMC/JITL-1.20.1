...
public class MiniSentryLord extends JMonsterEntity {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.MINI_SENTRY_LORD_HEALTH)
                .add(Attributes.ATTACK_DAMAGE, MobStats.MINI_SENTRY_LORD_DAMAGE)
                .add(Attributes.KNOCKBACK_RESISTANCE, MobStats.STANDARD_KNOCKBACK_RESISTANCE)
                .add(Attributes.FOLLOW_RANGE, MobStats.STANDARD_FOLLOW_RANGE)
                .add(Attributes.MOVEMENT_SPEED, MobStats.STANDARD_MOVEMENT_SPEED).build();
    }

    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.mini_sentry_lord.idle");
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.mini_sentry_lord.walk");
