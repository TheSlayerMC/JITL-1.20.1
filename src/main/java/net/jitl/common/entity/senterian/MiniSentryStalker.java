...
public class MiniSentryStalker extends JMonsterEntity {

    public MiniSentryStalker(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.mini_sentry_stalker.walk");
