...
public class OvergrownMerchant extends JVillagerEntity {
    ...
    public OvergrownMerchant(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.overgrown_merchant.walk");
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.overgrown_merchant.idle");
