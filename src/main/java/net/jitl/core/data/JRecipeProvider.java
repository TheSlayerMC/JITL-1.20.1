...
public class JRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected static void threeByThreePacker(@NotNull Consumer<FinishedRecipe> pRecipeOutput, @NotNull RecipeCategory pCategory, ItemLike pPacked, @NotNull ItemLike pUnpacked, @NotNull String pCriterionName) {
